{{
  ...
  after_show=" //<![CDATA[ $(document).ready(function(){ var pageGroup = window.location.pathname.split('/')[2]; var eventCategoryLink = $('.event-category-link'); eventCategoryLink.attr('href', eventCategoryLink.attr('href') + pageGroup); }); // ]]>" 
  after_show="</script>" 
